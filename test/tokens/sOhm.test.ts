...
describe("sOhm", () => {
  ...
  beforeEach(async () => {
    ...
    const authority = await (new SapiansAuthority__factory(initializer)).deploy(initializer.address, initializer.address, initializer.address, initializer.address);
