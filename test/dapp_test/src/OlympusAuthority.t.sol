...
import "../../../contracts/SapiansAuthority.sol";
import "../../../contracts/mocks/AccessControlledMock.sol";

contract SapiansAuthorityTest is DSTest {

    SapiansAuthority authority;
    ...
    function test_onlyGovernor_not_authorized() public {
        authority = new SapiansAuthority(UNAUTHORIZED_USER, address(this), address(this), address(this));
    ...
    function test_onlyGovernor_authorized() public {
        authority = new SapiansAuthority(address(this), address(this), address(this), address(this));
        accessControlledMock = new AccessControlledMock( address(authority) );
    ...
    function test_onlyGuardian_not_authorized() public {
        authority = new SapiansAuthority(address(this), UNAUTHORIZED_USER, address(this), address(this));
        accessControlledMock = new AccessControlledMock( address(authority) );
    ...
    function test_onlyPolicy_not_authorized() public {
        authority = new SapiansAuthority(address(this), address(this), UNAUTHORIZED_USER, address(this));
        accessControlledMock = new AccessControlledMock( address(authority) );
    ...
    function test_onlyVault_not_authorized() public {
        authority = new SapiansAuthority(address(this), address(this), address(this), UNAUTHORIZED_USER);
        accessControlledMock = new AccessControlledMock( address(authority) );
    ...
    // TODO create tests for push/pull mechanism within SapiansAuthority
