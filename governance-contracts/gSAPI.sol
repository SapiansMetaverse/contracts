...
contract gSAPI is IgSAPI, ERC20 {
    ...
    constructor(address _migrator, address _sSAPI)
        ERC20("Governance SAPI", "gSAPI", 18)
    {
     ...
     * @param _sSAPI address
     */
    function migrate(address _staking, address _sSAPI) external override onlyApproved {
        ...
        require(_sSAPI != address(0), "Zero address found");
        sSAPI = IsSAPI(_sSAPI);
    }
    ...
    /**
     * @notice pull index from sSAPI token
     */
    ...
    /**
        @notice converts gSAPI amount to SAPI
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts SAPI amount to gSAPI
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gSAPI::getPriorVotes: not yet determined");
