...
contract SapiansBondDepository is SapiansAccessControlled {
  ...
  function deposit(
    ...
    require(payout >= 10000000, "Bond too small"); // must be > 0.01 SAPI ( underflow protection )
  ...
  /**
   * @notice calculate current ratio of debt to SAPI supply
   * @param _BID uint
