...
contract BondTeller is ITeller, SapiansAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sSAPI remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable SAPI;
    IsSAPI internal immutable sSAPI; // payment token
    ...
    function newBond(
        ...
        SAPI.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        SAPI.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sSAPI.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of SAPI available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of SAPI available for claim for array of bonds
     * @param _bonder address
