...
import "../interfaces/ISapiansAuthority.sol";
...
contract LiquidityMigrator is SapiansAccessControlled {
    ...
    constructor(ISapiansAuthority _authority) SapiansAccessControlled(_authority) {}
